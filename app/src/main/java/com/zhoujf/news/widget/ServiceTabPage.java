...
public class ServiceTabPage extends BaseTabPage {
    private static final String TAG = "ServiceTabPage";
    public ServiceTabPage(Context context) {
        super(context);
    }

    public ServiceTabPage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
